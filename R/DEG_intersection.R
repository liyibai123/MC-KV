#' @title DEG_intersection
#' @description DEG analysis and genes intersection for subsequent process
...
DEG_intersection <- function(RNA_seq_dataframe, clin_info, MCKV_group){
 ...
 #Comparing group1 and group3
  ...
  RNA_seq_dataframe_Low_High=RNA_seq_dataframe_Low_High[rowMeans(RNA_seq_dataframe_Low_High)>1,]
